...
namespace CYShop.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        private readonly IUserStore<CYShopUser> _userStore;
        ...
        private CYShopUser CreateUser()
        {
            try
            {
                return Activator.CreateInstance<CYShopUser>();
            }
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(CYShopUser)}'. " +
                    $"Ensure that '{nameof(CYShopUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
                    $"override the register page in /Areas/Identity/Pages/Account/Register.cshtml");
            }
        }

        private IUserEmailStore<CYShopUser> GetEmailStore()
        {
